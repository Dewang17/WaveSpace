...
export default function Founders() {
  return (
    <>
      <section className="px-6 md:px-10 lg:px-18 py-20 lg:mx-auto sm:mx-auto md:mx-auto    xl:max-w-full">
        <h2 className="text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl  font-bold leading-tight text-left md:text-left">
