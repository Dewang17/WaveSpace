...
const [openIndex, setOpenIndex] = useState(null);
    return (
      <div>
        <section
          className=" text-[#ffffff] w-full relative overflow-hidden h-full"
...
"
      ...
      bg-gradient-to-t from-black/50 via-black/40 via-black/10 to-black/0"
        ...
        transition-all duration-500 ease-out"
                  >
                    Our approach of making things simpler and more effective
                    helps users go from browsing to checkout in a few simple
                    steps.
                  </p>
                </div>
              </div>
      ...
      bg-gradient-to-t from-black/50 via-black/40 via-black/10 to-black/0"
        ...
        transition-all duration-500 ease-out"
                  >
                    We build smooth interfaces that make it easy for teams to
                    work and manage tasks quickly.
                  </p>
                </div>
              </div>
